...
\end{axis}
\end{tikzpicture}
\caption{Distribution of the filtering scores in a random set of 10000 tweets; on the $x$-axis there are some equal-width score ranges. Tweets with no annotations are not shown.}
...
\end{axis}
\end{tikzpicture}
\caption{Precision and recall plot (for a set of about 1800 tweets, chosen randomly among) for the tweet filter.}
