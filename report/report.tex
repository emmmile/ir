...
\centering
    ...
    \hline
Tweet & Hashtags \\ \hline
Berlusconi è l'ex-presidente del consiglio & \#berlusconi s=2935 \#annozero s=377 \#ballar \#pdl \#laresadeiconti \#italy \#politica \#finecorsa \#italia \#rubygate\\
Monti giura e nomina il nuovo governo & \#governo s=345 \#berlusconi s=227 \#italia \#politica \#monti \#fiducia \#pdl \#opencamera \#referendum \#annozero\\
Grillo stravince a Parma, antipolica prende campo & \#parma s=456 \#annozero s=150  \#grillo \#parmalat \#notav \#m5s  \#juventus \#beppegrillo \#beppe \#calcio\\
\hline
    \end{tabular}
    \caption{Examples of tagger use.}
    \label{tab:tagger}
\end{table}
